...
(function( $, window, document, undefined ) {
	var ElevateZoom = {
			...
			startZoom: function( ) {
				...
				self.zoomContainer = $('<div class="zoomContainer" style="-webkit-transform: translateZ(0);position:absolute;z-index:1002;left:'+self.nzOffset.left+'px;top:'+self.nzOffset.top+'px;height:'+self.nzHeight+'px;width:'+self.nzWidth+'px;"></div>');
...
//						and on mouseleave check if scrolllock          
			...
			setElements: function(type) {
				...
				if(type=="show"){
					if(self.isWindowSet){
										hoverBg.stop(false,true).fadeIn(500);
				...
				if(type=="hide"){
									    hoverBg.stop(false,true).fadeOut(500);
